...
@Tag(name = "Contract Reference API", description = "Quản lý thông tin tham chiếu hợp đồng")
public class ContractRefController {
    ...
    public Response<?> getAllContractRefs(@RequestParam(name = "page", required = false, defaultValue = "0") Integer page,
        ...
        return Response.success(contractRefService.getAllContractRefs(page, size));
    }
}
