...
INSERT INTO customers (
    id, name, email, password, phone, birthday, status, gender, tax_code, organization_id, sign_image, created_at, updated_at
      ...
      (5, 'Đinh Khánh Ngân', 'dinhkhanhngan@gmail.com', '$2a$10$UPF5aWUqKSeuoJR0kpSAKumzjjvqOh7VdpQHVP8ptBoReHO13LXqe', '0905678901', '1993-09-21', 1, 'male', '333444555', 1, '{}'::jsonb, NOW(), NOW()),
      (6, 'Phạm Anh Tuấn', 'phamanhtuan@gmail.com', '$2a$10$UPF5aWUqKSeuoJR0kpSAKumzjjvqOh7VdpQHVP8ptBoReHO13LXqe', '0906789012', '1998-04-10', 1, 'female', '444555666', 1, '{}'::jsonb, NOW(), NOW()),
      ...
      (8, 'Đinh Đức Thuận', 'dinhducthuan@gmail.com', '$2a$10$UPF5aWUqKSeuoJR0kpSAKumzjjvqOh7VdpQHVP8ptBoReHO13LXqe', '0908901234', '1997-02-14', 1, 'female', '666777888', 1, '{}'::jsonb, NOW(), NOW()),
      (9, 'Trần Quang Huy', 'tranquanghuy@gmail.com', '$2a$10$UPF5aWUqKSeuoJR0kpSAKumzjjvqOh7VdpQHVP8ptBoReHO13LXqe', '0909012345', '1985-08-08', 1, 'male', '777888999', 1, '{}'::jsonb, NOW(), NOW()),
      ...
      (11, 'Phạm Như May', 'phamnhumay@gmail.com', '$2a$10$UPF5aWUqKSeuoJR0kpSAKumzjjvqOh7VdpQHVP8ptBoReHO13LXqe', '0911234567', '1989-03-09', 1, 'male', '999000111', 1, '{}'::jsonb, NOW(), NOW()),
      (12, 'Nguyễn Mạnh Trí', 'nguyenmanhtri@gmail.com', '$2a$10$UPF5aWUqKSeuoJR0kpSAKumzjjvqOh7VdpQHVP8ptBoReHO13LXqe', '0912345678', '1991-06-17', 1, 'female', '000111222', 1, '{}'::jsonb, NOW(), NOW()),
